...
public class LocalidadService {
	...
	public List<LocalidadDTO> getByFk(int fk) {

		List<LocalidadDTO> result = new ArrayList<>();

		for (Localidad object2 : localidadRepository.findByFk(fk)) {
	...
	/**
	 * This method transform all entities 'Localidad' in 'LocalidadDTO' in the
	 * database
	 * 
	 * @return entities 'Localidad' transformed in 'Localidad'DTO (Data transference
	 *         Object)
	 * @since 1.0
	 */
	 ...
	 * 
	 * @return entity 'Localidad' transformed in 'LocalidadDTO' (Data transference
	 *         Object)
	 * @since 1.0
	 */
	...
	/**
	 * This method transform an entity 'LocalidadDTO' in the entity 'Localidad' for
	 * save it in the database
	 * 
	 * @param localidadDTO it is an object DTO that comes from controller that will
	...
	/**
	 * This method call the repository for delete an entity 'Localidad' in the
	 * database for the id.
	 * 
